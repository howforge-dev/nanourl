...
<Section id="small" n={10} title="How the model fits in your browser">
  <p>
    ...
    to stay accurate despite the rounding. It matters: rounding to int4 with no such round costs
    about {numbers.static.int4RoundingNoTailPct}% worse compression, and the QAT tail claws most of
    that back, to about {numbers.static.int4TailGapPct}% behind the full-precision model. On the
    ...
    machine. Speed is a property of your device, not of this page, so the honest figure is the one
    your own machine gives: <a href="/bench.html">the benchmark page</a> measures it live, here, now.
  </p>
  <p>
    One group, concretely. Take {numbers.static.groupSize} neighbouring weights whose largest
