...
<Section id="viz" n={12} title="Reading the observatory">
  <p>
  ...
  <ul>
    <li>
      <b>Token chips</b> — section 4's pieces, each priced in bits (section 2). Click one to inspect
      the moment the model predicted it.
    </li>
    <li>
      <b>Attention</b> — section 6's looking-back weights, raw: {numbers.layers} layer tiles ×
    ...
    <li>
      <b>Residual stream</b> — section 6's whiteboard, photographed after each of the
    ...
    <li>
      <b>Arithmetic coder</b> — section 7, one step at a time: watch the interval narrow, the bits
      leave the stream, and an amber <code>?</code> mark a deferred bit until a later token resolves
      it.
    </li>
    <li>
      <b>Position embedding</b> — section 6's <b>wpe</b> table: the {numbers.block} position vectors
    ...
    <li>
      <b>Embedding atlas</b> — section 6's geometry: all {fmtCount(numbers.vocab)} piece-embeddings
